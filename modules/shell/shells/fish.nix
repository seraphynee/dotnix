  ...
  den.aspects.shell._.fish.homeManager =
    ...
    let
      ...
      commonAliasesFish = builtins.replaceStrings [ "@common_aliases@" ] [ commonAliases ] (
        builtins.readFile (paths.dots + "/config/fish/conf.d/common_aliases.fish")
      );
    in
    {
      xdg.configFile."fish/fish_plugins".source = paths.dots + "/config/fish/fish_plugins";
      xdg.configFile."fish/functions" = {
        source = paths.dots + "/config/fish/functions";
        recursive = true;
      };
      ...
      xdg.configFile."fish/conf.d/chezmoi.fish".source = paths.dots + "/config/fish/conf.d/chezmoi.fish";
      xdg.configFile."fish/conf.d/abbreviations.fish".source =
        paths.dots + "/config/fish/conf.d/abbreviations.fish";
      xdg.configFile."fish/conf.d/jujutsu.fish".source = paths.dots + "/config/fish/conf.d/jujutsu.fish";
      xdg.configFile."fish/conf.d/yazi.fish".source = paths.dots + "/config/fish/conf.d/yazi.fish";
      xdg.configFile."fish/conf.d/pet.fish".source = paths.dots + "/config/fish/conf.d/pet.fish";
      xdg.configFile."fish/conf.d/sk-git.fish".source = paths.dots + "/config/fish/conf.d/sk-git.fish";
      xdg.configFile."fish/conf.d/skim.fish".source = paths.dots + "/config/fish/conf.d/skim.fish";
      xdg.configFile."fish/conf.d/zoxide.fish".source = paths.dots + "/config/fish/conf.d/zoxide.fish";
